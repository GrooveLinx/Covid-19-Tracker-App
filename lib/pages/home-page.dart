  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<ConnectivityProvider>(
        builder: (context, conObj, _) {
          if (conObj.isOnline != null) {
            return conObj.isOnline
                ? isLoading
                    ? Center(
                                                        ...
                                                        builder: (_) =>
                                                          ...
                                                          recoveredToday:
                                                              countryData[index]
                                                                      ...
                                                                      'todayRecovered']
                                                                  .toString(),
                                                          todayDeaths: countryData[
                                                                      index][
                                                                  'todayDeaths']
                                                              .toString(),
                                                          casesToday: countryData[
                                                                      index]
                                                                  ['todayCases']
                                                              .toString(),
                                                        ),
                                                                    ...
                                                                    children: [
                                                                      Container(
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              'Cases : ${countryData[index]['cases']}' == null ? 'loading' : 'Cases : ${countryData[index]['cases']}',
                                                                            ...
                                                                            Text(
                                                                              'Deaths : ${countryData[index]['deaths']}' == null ? 'loading' : 'Deaths : ${countryData[index]['deaths']}',
                                                                              style: GoogleFonts.poppins(
                                                                                textStyle: TextStyle(
